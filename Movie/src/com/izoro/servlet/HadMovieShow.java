...
/**
 * Servlet implementation class HadMovieShow
 */
@WebServlet("/HadMovieShow")
public class HadMovieShow extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<HadMovie> movies=movieDaoImpl.showHadMovie(peopleId);
